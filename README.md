...
- Compute choice and common use-cases
- Local vs Portal
- Connectors
- CI/CD
- Monitoring
...
# Intro
Consumption vs. Standard and main differences, integration account etc. Focus on Standard
Architecture of Logic Apps?
# Pre reqs
...
Overview of Challenge and and background (Microsoft):

1) Create a Logic App in Portal
    ...
    - Test using Postman - to do this, navigate to the workflow being developed, go the the oviewview and copy the "Workflow URL". Load postman and create a new request using the local URL and pass in the [sample payload](Challenge%201/order_request.json)
...
Topics Covered:
1) Connector types - Builtin and Azure Managed
2) Using child workflows
3) Workflow types - Stateful and Stateless
4) Configuration
...
9) Rename the actions to be something more meaningful, such as "Order API" and "Get Stockl"
10) Test the API to make sure the APIs are being called correclty and the new message is in the correct format
11) Finally, create a new action to send the new message to a topic called "fulfilOrderTopic"
